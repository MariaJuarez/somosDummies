...
class FormularioEmpleado extends React.Component{
    ...
    render(){
        let {empleado, onSubmit, onChange} = this.props;
        ...
        return(
            <Form inline onSubmit={onSubmit}>
                ...
                <FormGroup controlId="cuil">
                    ...
                    <FormControl type="text" placeholder="Numero de cuil" defaultValue={empleado.cuil} onChange={onChange} />
                </FormGroup>{' '}

                <FormGroup controlId="formControlPromovidoLPS">
                    <ControlLabel>Senioriti</ControlLabel>
                    <FormControl componentClass="select" placeholder="select" defaultValue={empleado.senority} onChange={onChange}>
