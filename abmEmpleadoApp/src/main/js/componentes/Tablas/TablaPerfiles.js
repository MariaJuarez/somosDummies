...
class TablaPerfiles extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: [],
          ...
          <tbody>
            {
              ...
              <td className="text-center" key={'abreviatura'+i}>{person.abreviatura}</td>
              <td className="text-center" key={'descripcion'+i}>{person.descripcion}</td>
