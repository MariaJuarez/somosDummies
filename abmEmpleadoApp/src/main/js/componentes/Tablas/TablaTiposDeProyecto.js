...
class TablaTiposDeProyecto extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: [],
          ...
          <tbody>
            {
              ...
              <td className="text-center" key={'legajo'+i}>{person.descripcion}</td>
              <td className="text-center" key={'nombres'+i}>{person.baja}</td>
...
export default TablaTiposDeProyecto